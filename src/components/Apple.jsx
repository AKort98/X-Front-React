...
function Apple() {
  return (
    <div>
      <button className="bg-white w-full rounded-2xl p-2 flex  justify-center items-center gap-2 hover:opacity-90">
        <span>
          <svg
        ...
        <span className="text-gray-800 font-bold">Sign up with Apple</span>
      </button>
    </div>
  );
}
